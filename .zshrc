...
# set variable identifiying the chroot you work in (used in the promp bellow)
#if [ -z "$¨{debian_chroot:-}" ] && [ -r /etc/debian_chroot ]; then
#  debian_chroot=$(cat /etc/debian_chroot)
#fi
...
#aliases for update Ubuntu
alias ubuntuUpdate='/home/kur/Documentos/Scripts/./updateUbuntu.sh'

#aliases for see images in terminal
alias seeImage='kitty icat'

#aliases for cleaning ipc services running
alias kill_ipcs='/home/kur/Documentos/Scripts/./kill_ipcs.sh'
